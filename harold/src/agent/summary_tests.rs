...
fn normalizer_removes_terminal_controls_and_collapses_whitespace() {
    let cases = [
        ...
        ("before\u{1b}]0;secret\u{9c}after", Some("beforeafter")),
        ("before\u{90}secret\u{9c}after", Some("beforeafter")),
        ("before\u{1b}Psecret\u{1b}\\after", Some("beforeafter")),
        ("before\u{98}secret\u{9c}after", Some("beforeafter")),
        ("before\u{9e}secret\u{9c}after", Some("beforeafter")),
        ("before\u{9f}secret\u{9c}after", Some("beforeafter")),
