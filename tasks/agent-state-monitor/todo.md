...
- [ ] Update durable Harold documentation.
...
- [ ] Run formatting, focused tests, workspace tests, Clippy, docs, audit, and release/deploy checks.
...
- [ ] Obtain the required independent completion-review thumbs-up.
...
- [ ] Complete Task 12 independent final review and migrate verified durable documentation.
